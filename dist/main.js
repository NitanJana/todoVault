...
class DisplayController {
  ...
  static handleDeleteTodoButton() {
    ...
    if (currentProject.getName() === 'Tomorrow' && _storage__WEBPACK_IMPORTED_MODULE_3__["default"].getProjectList().getProject(currentProject.getTodo(this.parentNode.children[0].textContent).getProjectName()) !== null) {
      _storage__WEBPACK_IMPORTED_MODULE_3__["default"].removeTodo(_storage__WEBPACK_IMPORTED_MODULE_3__["default"].getProjectList().getProject(currentProject.getTodo(this.parentNode.children[0].textContent).getProjectName()), this.parentNode.children[0].textContent);
    }
