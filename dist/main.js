...
class DisplayController {
  ...
  static handleDeleteTodoButton() {
    const currentProject = DisplayController.getCurrentProject();
    if (currentProject.getName() === 'Today' && _storage__WEBPACK_IMPORTED_MODULE_3__["default"].getProjectList().getProject(currentProject.getTodo(this.parentNode.children[0].textContent).getProjectName()) !== null) {
      _storage__WEBPACK_IMPORTED_MODULE_3__["default"].removeTodo(_storage__WEBPACK_IMPORTED_MODULE_3__["default"].getProjectList().getProject(currentProject.getTodo(this.parentNode.children[0].textContent).getProjectName()), this.parentNode.children[0].textContent);
    }
    if (currentProject.getName() === 'This Week' && _storage__WEBPACK_IMPORTED_MODULE_3__["default"].getProjectList().getProject(currentProject.getTodo(this.parentNode.children[0].textContent).getProjectName()) !== null) {
      _storage__WEBPACK_IMPORTED_MODULE_3__["default"].removeTodo(_storage__WEBPACK_IMPORTED_MODULE_3__["default"].getProjectList().getProject(currentProject.getTodo(this.parentNode.children[0].textContent).getProjectName()), this.parentNode.children[0].textContent);
    }
    _storage__WEBPACK_IMPORTED_MODULE_3__["default"].removeTodo(currentProject,this.parentNode.children[0].textContent);
    this.parentNode.remove();
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/eachDayOfInterval/index.js");
...
class Storage{
  ...
  static loadWeeklyTodoList() {
    ...
    const weekDates = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])({ start: new Date(), end: (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(), 7) }).map((date) => (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(date, 'yyyy-MM-dd'));
